<%@ Page Title="" Language="C#" MasterPageFile="~/user/MasterPage.master" AutoEventWireup="true"
    CodeFile="EditProject.aspx.cs" Inherits="user_EditProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <table dir="rtl" style="width: 100%;">
            <tr>
                <td class="style1">
                    &nbsp;<b>عنوان درخواست:</b>
                    <br />
                    &nbsp; <font size="-1">عنوانی کوتاه برای درخواست خود بنویسید</font>
                </td>
                <td>
            ...
            <tr>
                <td class="style1">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ProjectTypeRadioButton"
                        ErrorMessage="لطفا نوع پروژه را تعیین کنید" Font-Bold="True" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                </td>
                <td>
                    &nbsp;
        ...
        <br />
        <asp:Button ID="SubmitButton" runat="server" Font-Bold="True" Text="تایید" 
